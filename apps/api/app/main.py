...
def export(request: ExportRequest) -> dict:
    ...
    (output / "statistics.json").write_text(json.dumps({"dataset_version": version, "created_at": datetime.now().isoformat(timespec="seconds"), "total_images": len(manifest)}, ensure_ascii=False, indent=2), encoding="utf-8")
